"""
capture_icmp_flood.py

Generate and capture a real ICMP flood
using Mininet.
...
def run():
    ...
    pcap_file = get_next_filename("icmp_flood")
    ...
    print("\nGenerating ICMP Flood (5 seconds)...")
    ...
    print("\n" + "=" * 60)
    print("ICMP Flood Capture Complete")
    print("=" * 60)
