"""
capture_udp_flood.py

Capture a UDP Flood in Mininet
...
def run():
    ...
    pcap_file = get_next_filename("udp_flood")
    ...
    print("\nGenerating UDP Flood (5 seconds)...")

    flood = h1.popen(
        "hping3 --udp --flood -p 5001 10.0.0.2"
    )
    ...
    print("\n" + "=" * 60)
    print("UDP Flood Capture Complete")
    print("=" * 60)
